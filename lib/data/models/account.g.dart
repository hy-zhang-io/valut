...
void _accountSerialize(
  ...
  writer.writeDouble(offsets[4], object.initialBalance);
...
Account _accountDeserialize(
  ...
  final object = Account(
    ...
    initialBalance: reader.readDoubleOrNull(offsets[4]) ?? 0,
...
extension AccountQueryFilter
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> isHiddenEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isHidden',
...
extension AccountQuerySortBy on QueryBuilder<Account, Account, QSortBy> {
  ...
  QueryBuilder<Account, Account, QAfterSortBy> sortByIsHidden() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHidden', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> sortByIsHiddenDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQuerySortThenBy
  ...
  QueryBuilder<Account, Account, QAfterSortBy> thenByIsHidden() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHidden', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> thenByIsHiddenDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHidden', Sort.desc);
    });
  }
...
extension AccountQueryWhereDistinct
  ...
  QueryBuilder<Account, Account, QDistinct> distinctByIsHidden() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQueryProperty
  ...
  QueryBuilder<Account, bool, QQueryOperations> isHiddenProperty() {
    return QueryBuilder.apply(this, (query) {
